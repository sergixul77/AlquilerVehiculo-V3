   ...
   /*Preguntar mañana */
    ...
    public void  getClienteModificado() {
        ...
        String telefono = tfTelefono.getText();
         /*Creo un nuevo cliente segun los parametros que me introduce el usuario por teclado en los inputs*/
    }
    ...
    private void comprobarDni () {
    	...
    	if (dni.matches("\\d{8}[A-HJ-NP-TV-Z]")) { /*Si el dni que le paso por el input es igual a la de la expresion regular*/
   ...
   private void comprobarTelefono() {
    ...
    void initialize() {
    	...
    	public Cliente devolverCliente () {
    		...
    		Cliente cliente = VistaGrafica.getInstancia().getControlador().buscar(Cliente.getClienteConDni(tfDni.getText())); /*deveuvel el cliente que tiene ese dni*/
